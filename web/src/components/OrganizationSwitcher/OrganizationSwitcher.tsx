...
const OrganizationSwitcher = ({ organizations }) => {
  ...
  const { currentOrganization, switchOrganization, defaultOrganization, setDefaultOrganization } = useOrganization()
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <h1 className="text-lg font-semibold tracking-tight">
            ...
            {organizations.find((org) => org.id === currentOrganization.id)?.name || 'Select Organization'}
          </h1>
      ...
      <DropdownMenuContent className="w-64">
        <DropdownMenuLabel className="p-2">Switch Organization</DropdownMenuLabel>
        <div className="p-2">
          ...
          .map((org) => (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                org.id === currentOrganization.id ? 'bg-primary/10 text-primary' : 'hover:bg-accent'
              )}
            >
